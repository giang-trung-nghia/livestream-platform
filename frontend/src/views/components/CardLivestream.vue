...
export default {
  ...
  methods: {
    onRedirectRoom() {
      this.$router.push({ path: `/live/${this.username}` });
    },
  },
};
</script>
...
<template>
  <div class="mb-3 card card-livestream card-redirect" @click="onRedirectRoom">
    <div class="card-body">
      <div class="thumbnail">
        <img
          :src="thumbnailSrc"
          alt="thumbnail livestream"
          class="thumbnail-img"
        />
      </div>
