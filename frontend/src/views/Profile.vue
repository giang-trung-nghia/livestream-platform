...
const onSave = () => {
  try {
    ...
    dialogMessage.value = "Failed to update user information";
    if (dialog.value) {
      dialog.value.show();
    }
  }
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <label
                    for="example-text-input disabled"
                ...
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Email address</label
                  >
                  <argon-input type="email" v-model="email" :disabled="true" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Name</label
                  >
                  <argon-input v-model="name" :disabled="!isEdit" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label">
                    Password</label
